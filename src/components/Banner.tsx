    ...
    return (
        ...
        >
            <motion.div
                ...
                className="flex w-fit flex-col gap-4 justify-center items-center bg-black/50 backdrop-blur-sm p-4 rounded-xl">
                <h2 className="text-sm md:text-base lg:text-lg text-yellow-100 ">|| ॐ ನಮಃ ಶಿವಾಯ ||</h2>
                <h2 className="text-base md:text-xl lg:text-2xl font-semibold text-yellow-100 ">ಶ್ರೀ ನೀಲಕಂಠೇಶ್ವರ ಸ್ವಾಮಿ ದೇವಸ್ಥಾನ</h2>
                <p className="text-base md:text-lg lg:text-xl text-white">ಶ್ರೀ ಜಂಗಮ ಸಂಸ್ಥಾನ ಮಠ</p>
                <p className="text-base md:text-lg lg:text-xl text-white">ಶ್ರೀ ಕ್ಷೇತ್ರ ಗುರುಪುರ</p>
            </motion.div>
        </div>
    )
}
